...
{
  progname="$(basename $0)"
  echo "$progname [auto|night|day|toggle]"
  echo "Without parameters, it will not do anything. This is useful for toggling the monitor"
  echo "With the parameter `auto`, it will set dark theme from $SUNSET to $SUNRISE"
